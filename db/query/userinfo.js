...
const userinfo ={
    ...
    SELECT_USER_INFO : `select user_id, user_name, birth, gender, phone, email, admin from userinfo where user_id = ?`,
    ...
    SELECT_USER_LIST : `select user_id, user_name, birth, gender, email, phone, admin from userinfo order by user_name asc limit ? offset ?`,
